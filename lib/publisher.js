...
export function buildPayloadFromUrl(url, { rankMin = 'Bronze', conditions = [], code: directCode = null } = {}) {
  ...
  // Accepter soit un code direct (RainsTEAM), soit extraire depuis URL (StakecomDailyDrops)
